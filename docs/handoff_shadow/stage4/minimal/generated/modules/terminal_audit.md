...
- Source hash: `275c6965993498d20826c8cb04f32528eee1fe6b430371b275502608d6022d26`

## Content contract evidence

| Topic | Required semantic responsibility | Authoritative source | Matched phrase |
|---|---|---|---|
| convergence_or_persistent_drift | Define how terminal convergence is distinguished from persistent drift or runaway. | docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态 | 持续 runaway |
| two_x_continuation | Require at least a 2x continuation audit before accepting a terminal classification or method ranking. | docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态 | 延长至少 2 倍 |
| false_plateau_checks | Reject false plateaus caused by clamps, temperature floors, or numerical saturation. | docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态 | 假平台 |
| task_performance_collapse | Define and preserve task-performance collapse separately from numerical failure. | docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态 | 任务效果崩溃、数值训练仍可运行 |
| support_or_variance_boundary | Track support or variance boundary events as a distinct scientific outcome. | docs/handoff.md: ### 可学习方差：远场路径提前触发支持收缩 -> ### 来源与聚合审计说明 | 支持/方差收缩 |
| nan_inf_numerical_failure | Track NaN/Inf and other non-finite optimizer failures as numerical collapse. | docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态 | NaN/Inf |
| separate_failure_reporting | Require task collapse, support or variance boundary events, and NaN/Inf to be reported separately. | docs/handoff.md: ### 可学习方差：远场路径提前触发支持收缩 -> ### 来源与聚合审计说明 | 任务性能崩溃、support/variance boundary 与 NaN/Inf 必须继续分开报告 |

## Source 1: docs/handoff.md: # 4. 论文机制实验总表与验收标准 -> # 5. 当前真实完成状态
...
## Source 2: docs/handoff.md: ### 可学习方差：远场路径提前触发支持收缩 -> ### 来源与聚合审计说明
