...
The implementation reuses existing Python files only; the temporary export workflow is development scaffolding and must be absent from the final stacked diff.
