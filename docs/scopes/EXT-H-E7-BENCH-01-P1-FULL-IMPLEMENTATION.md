...
The exact implementation patch is applied only after its frozen SHA-256 and five-file scope pass deterministic checks; this synchronization commit carries no scientific-variable change.
