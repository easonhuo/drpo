...
Python may only provide minimal recognition, validation and expansion of the configuration. In particular, the implementation must not hard-code `8`, `25`, `199`, `8000`, `9000`, or any successor grid hash/value as lambda-completion-specific Python logic. Historical COLDSTART provenance must remain valid.
