"""Minimal reviewer runtime for the unified nine-task Structured Generation path."""
    ...
    *,
    ...
    if method == "joint_fitted_reference_topr":
        ...
        if not bool(torch.isfinite(reference_loss)):
            raise FloatingPointError("non-finite reference loss")
...
def run_structured_generation(
    *,
    ...
    summary = {
        ...
        "countdown_special_data_path": False,
        "runs": all_runs,
