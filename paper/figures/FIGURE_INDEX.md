...
| `fig_e8_multitask_exp_response_nine_panel` | Historical nine-task EXP coefficient-response shape visualization | `scripts/figures/plot_e8_multitask_exp_response_curves.py` | `paper/iclr2027/figures/data/e8_multitask_exp_response/` | generated `.pdf`, `.png`, `.svg` | historical real-data-backed `pilot_response_shape_only`; uniform Gaussian visualization smoothing |
