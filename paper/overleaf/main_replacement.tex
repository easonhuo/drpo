...
\begin{wraptable}{r}{0.39\columnwidth}
\vspace{-0.6em}
\centering
\caption{\textbf{Protocol-matched external transfer summary.}
The D4RL and Countdown values are unchanged from the current composite panel;
Countdown-0.5B reports the best observed two-seed late-window Pass@8 from each
registered development sweep.}
