...
continuous Jacobian is \(H\succ0\), while the discrete Jacobian
\(I+\alpha H\) has eigenvalues strictly larger than one for every
\(\alpha>0\).
...
For a raw negative-update vector \(g(D)\) satisfying
\(\|g(D)\|_2=I(D)\), define
\[
