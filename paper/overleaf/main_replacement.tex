...
global scaling ignore remoteness; reciprocal tapers have polynomial tails and
can meet the matching order; DRPO uses the exponential member that satisfies
...
\begin{minipage}[t]{0.68\columnwidth}
    ...
    \includegraphics[
        width=\linewidth
    ]{figures/fig_6_4_2_drpo_label.pdf}
\end{minipage}
\hfill
...
\begin{aligned}
    ...
    &=
    \frac{1}
    {1+\lambda\left[(D-\tau)/c\right]_+},\\
    \omega_{\mathrm{Rec\text{-}Q}}(D)
    &=
    \frac{1}
    {1+\lambda\left(\left[(D-\tau)/c\right]_+\right)^2},\\
    \omega_{\mathrm{exp}}(D)
    &=
    \exp
    \left\{
