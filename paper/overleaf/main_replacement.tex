...
data, labels, initialization, optimizer, and budget. The Global-$\alpha$ entry
is unavailable because the corresponding nine-task evaluation has not been
completed. Because external tasks lack counterfactual near/far geometry,
Table~\ref{tab:taper_transfer_summary} provides descriptive transfer evidence
rather than a closed cross-task ranking.
