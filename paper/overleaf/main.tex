\input{main_replacement.tex}\endinput
...
\input{appendix/b_gaussian.tex}
\input{appendix/c_categorical.tex}
\input{appendix/d_environments.tex}
\input{appendix/e_protocols.tex}
\input{appendix/f_results.tex}
\input{appendix/g_reproducibility.tex}
\input{appendix/optimistic_dro.tex}
\input{appendix/h_corrections.tex}
\end{document}
