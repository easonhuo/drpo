...
aggregated over nine D4RL locomotion cells in (a) and structured-generation
tasks in (b). Gradients are normalized to their near-field references; dashed lines
show matched negative-signal controls and shading shows 95\% confidence intervals
