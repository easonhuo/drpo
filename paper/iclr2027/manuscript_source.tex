...
actor-gradient versus mean-token surprisal bin.
}
...
under repeated negative updates, while sharing D-U1's fixed-advantage
and near/far intervention logic. The semantic-generalization test is carried
by E6-C through the 64-action shared-semantic catalogue.
...
throughout. Protocol-matched methods share the registered task data, verifier
labels, optimization budget, and evaluation schedule within each task.
