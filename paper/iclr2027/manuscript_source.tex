...
and~\ref{app:structured_generation_methods} give the protocols.
...
\paragraph{Experimental role.}
External taper experiments test transfer of the controlled weighting principle
to complex policies; C-U1 and D-U1 provide the counterfactual source-isolation
and causal-intervention tests.
...
External taper comparisons include Positive-only, Uncontrolled, Global
scaling, Reciprocal-Linear, Reciprocal-Quadratic, and exponential DRPO;
domain-specific baselines are reported separately in the overall-performance
section. Hopper reports normalized return and policy
