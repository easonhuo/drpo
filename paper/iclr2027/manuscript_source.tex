...
Closed-loop consequences are consistent with the same control principle. For the
fixed-covariance Gaussian mean field, exponential tapering makes trajectories
...
\ref{app:categorical_restoring_balance}. A finite-measure I-divergence
interpretation is given in Appendix~\ref{app:finite_measure_variational}.
