...
Matched operating points (left: near-field-retention matched; right:
aggregate-budget matched); bars decompose retained negative-update magnitude
into near- and far-field components, and dashed traces show
