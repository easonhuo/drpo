...
\begin{figure}[t]
    ...
    \caption{
        ...
        values are normalized to the near-field reference within seed and
        dataset. The line reports the cross-dataset mean, the shaded region
...
\begin{figure*}[t]
    ...
    distance. Values are normalized to the near-field reference within seed;
    lines show 10-seed means and shaded regions show seed-level bootstrap 95\%
