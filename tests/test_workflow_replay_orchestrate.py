...
HISTORICAL_BASE = "531506b4be6967012c5d01aa4d112deaaccf1c49"
HISTORICAL_HEAD = "e17fbedcdf326cda2780bfd075ff6ee3f9f09c79"
...
def test_replacement_c01_arm_a_calibration(tmp_path: Path) -> None:
    ...
    contract = SimpleNamespace(
        ...
        sha256="c01-pr122-arm-a-calibration",
    )
    ...
    summary = {
        ...
        "historical_claim_id": "EXT-H-E7-SQEXP-GAE-01",
        "case_id": "C01-CODE-ONLY",
    ...
    evidence = ROOT / "c01-pr122-calibration.tar.gz"
