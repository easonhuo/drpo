...
def test_replacement_c01_arm_a_calibration(tmp_path: Path) -> None:
    ...
    contract = SimpleNamespace(
        base=SimpleNamespace(
            historical_task={
                "base_sha": "531506b4be6967012c5d01aa4d112deaaccf1c49",
                "frozen_implementation_sha": "5b56bc3384e36b52ef72177d6e7d2430ee0488cc",
            },
            benchmark={"toolchain_sha": TOOLCHAIN},
        ),
        sha256="c01-pr120-arm-a-calibration",
    )
    ...
    evidence = ROOT / "c01-pr120-calibration.tar.gz"
