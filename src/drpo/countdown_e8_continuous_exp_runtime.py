#!/usr/bin/env python3
"""Runtime orchestration for the E8 continuous EXP code-first pilot."""
...
from drpo.countdown_e8_continuous_exp_trainer import train_cell
...
def _aggregate(work_dir: Path, cells: Sequence[Cell]) -> dict[str, Any]:
...
def run(args: argparse.Namespace) -> int:
    ...
    audit = _aggregate(work_dir, cells)
