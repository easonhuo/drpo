#!/usr/bin/env python3
"""One-decision Countdown V4.4 fixed offline negative-bank pilot launcher.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the registered Countdown V4.4 offline-bank pilot under the hardened guard"
    )
