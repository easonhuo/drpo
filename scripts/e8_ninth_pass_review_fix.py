...
# Historical reporting/execution provenance is part of the frozen experiment identity.
...
# Keep existing config-driven test fixtures self-consistent when they mutate PO seeds.
