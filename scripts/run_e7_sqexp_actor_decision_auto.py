#!/usr/bin/env python3
"""Plan or run the 192-branch E7 actor/high-c decision pilot."""
...
from drpo.e7_sqexp_actor_decision_aggregate import aggregate
from drpo.e7_sqexp_actor_decision_runtime_autotune import select_runtime
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--fallback-workers", type=int, default=96)
    parser.add_argument("--probe-steps", type=int, default=5_000)
    parser.add_argument("--probe-seed", type=int, default=993_201)
