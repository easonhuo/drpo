#!/usr/bin/env python3
"""Run the 84-branch E7 high-c A2C/PPO pilot with automatic resources."""
...
from drpo.e7_w0_highc_runtime_autotune import select_runtime
...
def _validate_existing_run_identity(work_dir: Path, selected_workers: int) -> None:
    ...
    if existing != selected_workers:
        raise RuntimeResourceError(
            "existing high-c run identity fixes max_workers="
        ...
        json.dumps(
            {
                ...
                "selection_scope": "short empirical candidate grid under a CPU/RAM safety ceiling",
            },
            sort_keys=True,
        ),
        flush=True,
